...
content_meta:
  content_type: 'Course'
  difficulty: 'Graduate'
  prerequisites: ['Engineering Data Governance for Sustainable Strategy (recommended)', 'Basic BIM literacy']
  trending: false
---
...
{{< cards >}}
  {{< card title="Information Architecture" icon="squares-2x2" subtitle="Data governance theory, international standards, and applied technologies" >}}
  {{< card title="Digital Twin Deployment" icon="cube-transparent" subtitle="Planning digital twins for real construction and facility contexts" >}}
  {{< card title="Low-Code Automation" icon="bolt" subtitle="Building executable workflows that move data without manual rework" >}}
{{< /cards >}}
