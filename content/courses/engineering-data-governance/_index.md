...
content_meta:
  content_type: 'Course'
  difficulty: 'Graduate'
  prerequisites: ['Basic BIM literacy', 'Introductory engineering economics']
  trending: false
---
...
{{< cards >}}
  {{< card title="Semantic Bridging" icon="link" subtitle="Connecting BIM models with cost-estimation and procurement documents" >}}
  {{< card title="Embodied Carbon Databases" icon="globe-alt" subtitle="Applying carbon inventories to real design and procurement decisions" >}}
  {{< card title="Procurement Analysis" icon="clipboard-document-check" subtitle="Structuring supplier evaluation around sustainability criteria" >}}
  {{< card title="Sustainability Reporting" icon="chart-bar" subtitle="Building auditable, low-code carbon-tracking workflows" >}}
{{< /cards >}}
